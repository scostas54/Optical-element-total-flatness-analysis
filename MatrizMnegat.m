function [M]=MatrizMnegat(D) % Enter the number of diameters in which you want to
% divide the image and the function returns the matrix M
...
% Obtaining the first matrix similar to the identity but with the rows in
% changed position
cont2=0;
for cont1=(2*D-1):(-1):1       
        cont2=cont2+1;    
